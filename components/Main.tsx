            ...
            <section className='bgMain'>
                <div className='maxW flex flex-col justify-center h-full'>
                    ...
                    <article className='mt-10 flex flex-col items-start'>
                        <div className='bg-BrowP text-white px-10 py-4 text-lg font-medium tracking-wide uppercase'>
                            01 Tratamentos com Laser
                        </div>
                        <div className='bg-[#824847] text-white px-10 py-4 text-lg font-medium tracking-wide uppercase'>
                            02 Harmonização Facial
                        </div>
                        <div className='bg-[#9c6463] text-white px-10 py-4 text-lg font-medium tracking-wide uppercase '>
                            03 Preenchimentos
                        </div>
                        <div className='bg-[#b2807f] text-white px-10 py-4 text-lg font-medium tracking-wide uppercase w-56'>
                            04 Botox
                        </div>
                    </article>
